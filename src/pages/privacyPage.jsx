        ...
        <>
            ...
            <div className="container">
                ...
                <div className="policy_page">
                    <ol>
                        <li>
                            <span className="title">Общие положения</span>
                            <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Михайловым Иваном Сергеевичем (далее — Оператор).</p>
                            <ol>
                                <li>
                                    <span>Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</span>
                                </li>
                                <li>
                                    <span>Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="httpsː//thismywebsite·com">httpsː//thismywebsite·com</a>.</span>
                                </li>
                            </ol>
                            </li>
                        <li>
                            <span className="title">Основные понятия, используемые в Политике</span>
                            <ol>
                                <li>
                                ...
                                <li>
                                    <span>Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="httpsː//thismywebsite·com">httpsː//thismywebsite·com</a>.</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span>Обезличивание персональных данных — действия, в результате которых невозможно определить без использования дополнительной информации принадлежность персональных данных конкретному Пользователю или иному субъекту персональных данных.</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span>Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="httpsː//thismywebsite·com">httpsː//thismywebsite·com</a>.</span>
                                </li>
                                <li>
                                    <span>Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).</span>
                                </li>
                                <li>
                                    <span>Пользователь — любой посетитель веб-сайта <a href="httpsː//thismywebsite·com">httpsː//thismywebsite·com</a>.</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span>Уничтожение персональных данных — любые действия, в результате которых персональные данные уничтожаются безвозвратно с невозможностью дальнейшего восстановления содержания персональных данных в информационной системе персональных данных и/или уничтожаются материальные носители персональных данных.</span>
                                </li>
                            </ol>
                        </li>
                        <li>
                            <span className="title">Основные права и обязанности Оператора</span>
                            <ol>
                                <li>
                        ...
                        <li>
                            <span className="title">Цели обработки персональных данных</span>
                            <div className="policy_table">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-mobile-title="Параметр 1">Отправка электронных писем Пользователю</td>
                                            <td data-mobile-title="Параметр 2">Отправка электронных писем Пользователю</td>
                                            <td data-mobile-title="Параметр 3">Отправка электронных писем Пользователю</td>
                                        </tr>
                                        <tr>
                                            <td data-mobile-title="Параметр 1">Философские убеждения</td>
                                            <td data-mobile-title="Параметр 2">Философские убеждения</td>
                                            <td data-mobile-title="Параметр 3">Философские убеждения</td>
                                        </tr>
                                        <tr>
                                            <td data-mobile-title="Параметр 1">ФЗ от 27.07.2006 N 149-ФЗ</td>
                                            <td data-mobile-title="Параметр 2">ФЗ от 27.07.2006 N 149-ФЗ</td>
                                            <td data-mobile-title="Параметр 3">ФЗ от 27.07.2006 N 149-ФЗ</td>
                                        </tr>
                                        <tr>
                                            <td data-mobile-title="Параметр 1">Передача персональных данных</td>
                                            <td data-mobile-title="Параметр 2">Передача персональных данных</td>
                                            <td data-mobile-title="Параметр 3">Передача персональных данных</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
